...
app.layout = html.Div(children=[
    ...
    # TASK 4: Success Scatter Chart
    html.Div(dcc.Graph(id='success-payload-scatter-chart')),
])

# TASK 2 Callback: Pie Chart logic
@app.callback(
...
# TASK 4 Callback: Scatter Chart logic
@app.callback(
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(
            ...
            color='Booster Version Category',
            title=f'Success by Payload and Booster for site {entered_site}')
        return fig
